  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ULTA_Beauty_Logo-iIbs9A55niTRy8M9np6RLZX18tZ6WK.png"
            alt="Ulta Beauty"
        ...
        {/* Headline */}
        <h1
          className={`text-[1.625rem] sm:text-4xl md:text-[2.75rem] lg:text-5xl font-semibold text-foreground leading-[1.25] sm:leading-[1.15] mb-5 sm:mb-6 max-w-[340px] sm:max-w-2xl md:max-w-3xl mx-auto transition-all duration-700 ease-out delay-100 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
          The{" "}<span className="text-[#ff6f3c]">Ulta Method</span>{" "}That&apos;s Changing Everything
        </h1>
        ...
        >
          Discover how people are saving on makeup, skincare, haircare, and everyday beauty essentials.
        </p>
        ...
        >
          <a
            href="https://trksy.org/aff_c?offer_id=1181&aff_id=26188"
            target="_blank"
            rel="noopener noreferrer"
            className="touch-button group inline-flex items-center gap-3 bg-[#ff6f3c] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#e5622f] transition-all duration-300 hover:shadow-xl hover:shadow-[#ff6f3c]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
        ...
        >
          ...
          <p className="text-sm text-muted-foreground/70 font-medium">
            <span className="sm:hidden">Join 12,000+ beauty lovers who&apos;ve<br />already claimed their rewards.</span>
            <span className="hidden sm:inline">Join 12,000+ beauty lovers who&apos;ve already claimed their rewards.</span>
          </p>
        </div>
      </div>
    </section>
