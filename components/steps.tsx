...
const steps = [
  {
    ...
    description: "Start your journey to beauty savings",
  },
  {
    icon: Mail,
  ...
  {
    icon: ClipboardCheck,
    title: "Complete the Ulta survey",
    description: "Share your beauty preferences",
  },
  {
    icon: Gift,
  ...
  {
    icon: Trophy,
    title: "Receive your $750 Ulta gift card",
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4">
            {steps.map((step, index) => (
              <div
                key={index}
                className={`group bg-card border border-border/60 rounded-2xl p-5 hover:border-[#ff6f3c]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[#ff6f3c]/5 hover:-translate-y-1 touch-card ${
              ...
              >
                <div className="flex items-start gap-4">
                  {/* Step number */}
                  <div
                    className={`flex-shrink-0 w-8 h-8 bg-[#ff6f3c] text-white rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-500 ${
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="touch-icon w-12 h-12 bg-muted rounded-xl flex items-center justify-center mb-3 group-hover:bg-[#ff6f3c]/10 transition-colors duration-300">
                      <step.icon className="w-6 h-6 text-foreground/70 group-hover:text-[#ff6f3c] transition-colors duration-300" strokeWidth={1.5} />
                    </div>
